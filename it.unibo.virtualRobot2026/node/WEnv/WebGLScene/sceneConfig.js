...
/*     
   ...
   staticObstacles: [
	{
	    name: "slot1",
	    centerPosition: { x: 0.4, y: 0.65},
	    size: { x: 0.08, y: 0.065      }
	},
	{
	    name: "slot2",
	    centerPosition: { x: 0.5, y: 0.65},
	    size: { x: 0.08, y: 0.065      }
	},
	{
	    name: "slot3",
	    centerPosition: { x: 0.4, y: 0.3}, 
	    size: { x: 0.08, y: 0.065      }
	},
	{
	    name: "slot4",
...
*/		 		 
        {
            name: "wallUp",
            centerPosition: { x: 0.49, y: 0.97},
            size: { x: 0.96, y: 0.02}
        },
		{ 
		     name: "wallDownAngle",
		     centerPosition: { x: 0.05, y: 0.01},
		     size: { x: 0.05, y: 0.01}
		 },
       {
            name: "wallDown",
            centerPosition: { x: 0.6, y: 0.01},
            size: { x: 0.77, y: 0.01}
        },
        {
            name: "wallLeft",
